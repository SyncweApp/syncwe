...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { name: 'author', content: 'TogotherApp' }],
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/TogotherApp/togother-docs' }
    ],
    ...
    footer: {
      message: '基于 MIT 许可发布',
      copyright: 'Copyright © 2024-present TogotherApp'
    },
    ...
    editLink: {
      pattern: 'https://github.com/TogotherApp/togother-docs/edit/main/docs/:path',
