...
1. 访问规则仓库：[https://github.com/TogotherApp/TogotherRules](https://github.com/TogotherApp/TogotherRules)
2. Fork 项目到您的账号
3. 添加或修改规则文件
4. 提交 Pull Request
5. 等待审核合并
...
<picture>
  <source
    ...
    srcset="
      https://api.star-history.com/svg?repos=TogotherApp/togother-docs&type=Date&theme=dark
    "
  />
  <source
    media="(prefers-color-scheme: light)"
    srcset="
      https://api.star-history.com/svg?repos=TogotherApp/togother-docs&type=Date
    "
  />
  <img
    alt="Star History Chart"
    src="https://api.star-history.com/svg?repos=TogotherApp/togother-docs&type=Date"
  />
</picture>
